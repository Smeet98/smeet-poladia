    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-4xl mx-auto text-center">
          {/* Status indicator */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full border border-primary/30 bg-secondary/50 backdrop-blur-sm animate-fade-up">
          ...
          {/* Stats row */}
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-12 animate-fade-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold font-mono text-foreground">Stats</div>
