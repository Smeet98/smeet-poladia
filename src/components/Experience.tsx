...
const experiences = [
  {
    ...
    company: "Entrix GmbH",
    description: "Optimizing battery storage operations and energy dispatch using quantitative models to maximize efficiency and revenue.",
    flag: "🇩🇪",
  },
  {
    period: "2024 - 2025",
